export default function Introduction({ contentRef }) {
  return (
    <div id="introduction" className="w-full flex flex-col justify-center">

      <div ref={contentRef} className="flex flex-col z-10">
        <div 
          className="ripped py-[10%] pb-[15%] flex flex-col items-center justify-center justify-items-center bg-cover bg-no-repeat z-[20] before:absolute before:inset-0 before:bg-black/60 before:z-[-1]" 
