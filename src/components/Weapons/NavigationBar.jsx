...
export default function NavigationBar({ selectedType, setSelectedType }) {
    return (
        <div className="w-full h-17 flex items-center rounded-lg border-b-2 border-b-blue-300 shadow-md">
          ...
          >
            <img className="w-8 h-8" src={`${import.meta.env.BASE_URL}home/Great_Sword_Icon_White.svg}`} alt="" />
          </a>
          ...
          >
            <img className="w-8 h-8" src={`${import.meta.env.BASE_URL}home/Long_Sword_Icon_White.svg}`} alt="" />
          </a>
          ...
          >
            <img className="w-8 h-8" src={`${import.meta.env.BASE_URL}home/Sword_and_Shield_Icon_White.svg}`} alt="" />
          </a>
          ...
          >
            <img className="w-8 h-8" src={`${import.meta.env.BASE_URL}home/Dual_Blades_Icon_White.svg}`} alt="" />
          </a>
          ...
          >
            <img className="w-8 h-8" src={`${import.meta.env.BASE_URL}home/Hammer_Icon_White.svg}`} alt="" />
          </a>
          ...
          >
            <img className="w-8 h-8" src={`${import.meta.env.BASE_URL}home/Hunting_Horn_Icon_White.svg}`} alt="" />
          </a>
          ...
          >
            <img className="w-8 h-8" src={`${import.meta.env.BASE_URL}home/Lance_Icon_White.svg}`} alt="" />
          </a>
          ...
          >
            <img className="w-8 h-8" src={`${import.meta.env.BASE_URL}home/Gunlance_Icon_White.svg}`} alt="" />
          </a>
          ...
          >
            <img className="w-8 h-8" src={`${import.meta.env.BASE_URL}home/Switch_Axe_Icon_White.svg}`} alt="" />
          </a>
          ...
          >
            <img className="w-8 h-8" src={`${import.meta.env.BASE_URL}home/Charge_Blade_Icon_White.svg}`} alt="" />
          </a>
          ...
          >
            <img className="w-8 h-8" src={`${import.meta.env.BASE_URL}home/Insect_Glaive_Icon_White.svg}`} alt="" />
          </a>
          ...
          >
            <img className="w-8 h-8" src={`${import.meta.env.BASE_URL}home/Light_Bowgun_Icon_White.svg}`} alt="" />
          </a>
          ...
          >
            <img className="w-8 h-8" src={`${import.meta.env.BASE_URL}home/Heavy_Bowgun_Icon_White.svg}`} alt="" />
          </a>
          ...
          >
            <img className="w-8 h-8" src={`${import.meta.env.BASE_URL}home/Bow_Icon_White.svg}`} alt="" />
          </a>
        </div>
      );
}