...
export default function NavigationBar({ selectedType, setSelectedType }) {
    return (
        <div className="w-full h-17 flex items-center rounded-lg border-b-2 border-b-blue-300 shadow-md">
          ...
          >
            <img className="w-8 h-8" src="src/assets/home/Great_Sword_Icon_White.svg" alt="" />
          </a>
          ...
          >
            <img className="w-8 h-8" src="src/assets/home/Long_Sword_Icon_White.svg" alt="" />
          </a>
          ...
          >
            <img className="w-8 h-8" src="src/assets/home/Sword_and_Shield_Icon_White.svg" alt="" />
          </a>
          ...
          >
            <img className="w-8 h-8" src="src/assets/home/Dual_Blades_Icon_White.svg" alt="" />
          </a>
          ...
          >
            <img className="w-8 h-8" src="src/assets/home/Hammer_Icon_White.svg" alt="" />
          </a>
          ...
          >
            <img className="w-8 h-8" src="src/assets/home/Hunting_Horn_Icon_White.svg" alt="" />
          </a>
          ...
          >
            <img className="w-8 h-8" src="src/assets/home/Lance_Icon_White.svg" alt="" />
          </a>
          ...
          >
            <img className="w-8 h-8" src="src/assets/home/Gunlance_Icon_White.svg" alt="" />
          </a>
          ...
          >
            <img className="w-8 h-8" src="src/assets/home/Switch_Axe_Icon_White.svg" alt="" />
          </a>
          ...
          >
            <img className="w-8 h-8" src="src/assets/home/Charge_Blade_Icon_White.svg" alt="" />
          </a>
          ...
          >
            <img className="w-8 h-8" src="src/assets/home/Insect_Glaive_Icon_White.svg" alt="" />
          </a>
          ...
          >
            <img className="w-8 h-8" src="src/assets/home/Light_Bowgun_Icon_White.svg" alt="" />
          </a>
          ...
          >
            <img className="w-8 h-8" src="src/assets/home/Heavy_Bowgun_Icon_White.svg" alt="" />
          </a>
          ...
          >
            <img className="w-8 h-8" src="src/assets/home/Bow_Icon_White.svg" alt="" />
          </a>
        </div>
      );
}