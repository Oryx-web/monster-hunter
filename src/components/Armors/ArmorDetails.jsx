...
export default function ArmorDetails({ selectedArmor, getArmorIcon }) {
  ...
  return (
    <>
      ...
      <div className="flex gap-x-10 content-around justify-around">
      ...
      <div className="mt-4 border ml-5 mr-5 w-1/1 border-gray-700 rounded-md">
        ...
        <ul className="px-3 py-3 grid grid-cols-3 gap-5 justify-between justify-items-center text-white">
