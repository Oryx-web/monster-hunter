...
export default function NavigationBar({ selectedType, setSelectedType }) {
  return (
    <div className="bg-orange-900 brightness-75 w-full h-30 flex items-center justify-around bg-[length:100%_100%] bg-no-repeat border-2 border-black rounded-lg shadow-md" style={{ backgroundImage: url("/background.webp")}}>
      <a
      ...
      >
        ...
        <img className="w-12 h-12 mt-2" src="/icons/MHW-Rathalos_Icon.svg" alt="" loading='lazy'/>
      </a>
      ...
      >
        ...
        <img className="w-12 h-12 mt-2" src="/icons/MHW-Apceros_Icon.svg" alt="" loading='lazy'/>
      </a>
      ...
      >
        ...
        <img className="w-12 h-12 mt-2" src="/icons/MHW-Vespoid_Icon.svg" alt="" loading='lazy'/>
      </a>
    </div>
  );
}