  ...
  return (
    <div className="bg-orange-900 brightness-75 w-full h-30 flex items-center justify-around bg-[length:100%_100%] bg-no-repeat border-2 border-black rounded-lg shadow-md" style={{ backgroundImage: "url('src/assets/banner.webp')" }}>
      ...
      >
        ...
        <img className="w-12 h-12 mt-2" src={`${import.meta.env.BASE_URL}src/assets/icons/MHW-Rathalos_Icon.svg`} alt="" loading='lazy'/>
      </a>
      ...
      >
        ...
        <img className="w-12 h-12 mt-2" src={`${import.meta.env.BASE_URL}src/assets/icons/MHW-Apceros_Icon.svg`} alt="" loading='lazy'/>
      </a>
      ...
      >
        ...
        <img className="w-12 h-12 mt-2" src={`${import.meta.env.BASE_URL}src/assets/icons/MHW-Vespoid_Icon.svg`} alt="" loading='lazy'/>
      </a>
    </div>
  );
}