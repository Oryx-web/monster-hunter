...
export default function MonsterList({ monsters, selectedMonster, handleMonsterClick, getMonsterIcon }) {
  return (
    <div className="space-y-2 max-h-screen overflow-y-auto grayscale-40 bg-no-repeat bg-cover" style={{ backgroundImage: `url('${import.meta.env.BASE_URL}banner.webp')`}}>
