              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full">
                {GEAR_SECTIONS.map((section) => (
                  ...
                  >
                    ...
                    />
                    <div className="absolute inset-0 flex flex-col items-center justify-center bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity duration-300 py-3 text-shado justify-items-center w-full h-full shade">
                      <p className="text-white text-lg text-center font-bold p-4 rounded-lg">
                        {section.description}
                      </p>
                    </div>
                  </a>
